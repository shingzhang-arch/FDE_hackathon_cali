...
export default function NorthStar() {
  return (
    <section id="north-star" className="mb-24 scroll-mt-20 -mx-6 md:-mx-8">
      <div className="relative min-h-[80vh] bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <motion.div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-200/20 rounded-full blur-3xl"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 pt-20 pb-32 flex flex-col items-center justify-center min-h-[80vh]">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-200 text-blue-700 text-sm font-medium mb-8"
          >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-slate-700 text-center max-w-3xl mb-12"
          >
          ...
          >
            {[
              ...
              <div
                key={index}
                className="px-5 py-2.5 rounded-full bg-white border-2 border-slate-300 text-slate-700 font-medium text-sm md:text-base shadow-sm"
              >
                {pillar}
              </div>
            ))}
